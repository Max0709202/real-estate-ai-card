...
<body>
    ...
    <span style="font-size: 14px;"><span style="color: #000000;"><span style="color: #000000;"><strong>物件の良し悪しを自動でしかも一瞬で判定するセルフインスペクションWEBアプリ。ネガティブ情報の発見にご活用ください。</strong></span></span>
</p></div>',
                            'banner_image' => BASE_URL . '/assets/images/lp_icon/slp.png'
                        ],
                        'rlp' => [
                            'description' => '<div id="cc-m-13442765431" class="j-module n j-text "><p>
    <span style="font-size: 14px;"><span style="color: #000000;"><span style="color: #000000;"><strong>希望条件に合う新着の売却情報を売り出しから24時間以内にAI評価付きで毎日配信します。希望物件の見落としが無くなります。</strong></span></span>
</p></div>',
                            'banner_image' => BASE_URL . '/assets/images/lp_icon/rlp.png'
                        ],
                        'llp' => [
                            'description' => '<div id="cc-m-13442765431" class="j-module n j-text "><p>
    <span style="font-size: 14px;"><span style="color: #000000;"><span style="color: #000000;"><strong>建てたい工務店は決まっているのに、土地情報を探しているお客様向け。新着の土地売却情報を売り出しから24時間以内に毎日配信します。</strong></span></span>
</p></div>',
                            'banner_image' => BASE_URL . '/assets/images/lp_icon/llp.png'
                        ],
                        'mdb' => [
                            'description' => '<div id="cc-m-13442765431" class="j-module n j-text "><p>
    <span style="font-size: 14px;"><span style="color: #000000;"><span style="color: #000000;"><strong>国内最大規模のマンションデータベース。
マンションの基礎情報・販売履歴をはじめ、口コミなども閲覧できます。</strong></span></span>
</p></div>',
                            'banner_image' => BASE_URL . '/assets/images/lp_icon/mdb.png'
                        ],
                        'ai' => [
                            'description' => '<div id="cc-m-13442765431" class="j-module n j-text "><p>
    <span style="font-size: 14px;"><span style="color: #000000;"><span style="color: #000000;"><strong>個人情報不要で、膨大な販売履歴より瞬時にマンションの価格を査定します。いつでも自分のマンションの査定が可能です。</strong></span></span>
</p></div>',
                            'banner_image' => BASE_URL . '/assets/images/lp_icon/ai.png'
                        ],
                        'olp' => [
                            'description' => '<div id="cc-m-13442765431" class="j-module n j-text "><p>
    <span style="font-size: 14px;"><span style="color: #000000;"><span style="color: #000000;"><strong>今日の自宅の価格、今日の残債、今日売ったらいくら手元に残るかなど、登録すると1週間に1回配信されます。他住戸の売り出し情報が出たら直ちに情報を配信します。</strong></span></span>
</p></div>',
                            'banner_image' => BASE_URL . '/assets/images/lp_icon/olp.png'
                        ],
                        'alp' => [
                            'description' => '<div id="cc-m-13442765431" class="j-module n j-text "><p>
    <span style="font-size: 14px;"><span style="color: #000000;"><span style="color: #000000;"><strong>１　全国マンションデータベース<br>
２　物件提案ロボ<br>
３　土地情報ロボ<br>
４　AIマンション査定<br>
５　セルフィン<br>
６　オーナーコネクト<br>
これら6つのツールをご紹介するページです。</strong></span></span>
</p></div>',
