...
<body>
    ...
    <main class="static-page">
        <div class="container terms-container">
            ...
            <h3>第1条（目的）</h3>
            <ol class="terms-list">
                <li>本規約は、リニュアル仲介株式会社（以下「当社」といいます。）が提供する「不動産AI名刺」ならびにこれに付随するAIチャット機能、顧客管理機能、進捗管理機能、住宅ローンシミュレーター、AI査定機能、SelFinPRO連携機能、全国マンションデータベース連携機能、PDF解析機能その他関連サービス（以下総称して「本サービス」といいます。）の利用条件を定めるものです。</li>
                <li>利用者は、本規約に同意したうえで本サービスを利用するものとします。</li>
                <li>本サービスは不動産事業者向け営業支援ツールとして提供されるものであり、当社は利用者の営業成果、顧客獲得、売上向上その他の成果を保証するものではありません。</li>
            </ol>
            ...
            <h3>第3条（適用）</h3>
            <ol class="terms-list">
                <li>本規約は、本サービス利用に関する当社と利用者との一切の関係に適用されます。</li>
                <li>当社が本サービス上または当社ウェブサイト上に掲載するガイドライン、マニュアル、ヘルプページ、FAQ、運用ルールその他の規定は、本規約の一部を構成するものとします。</li>
                <li>本規約と個別契約の内容が異なる場合は、個別契約の内容が優先されます。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第4条（規約の変更）</h3>
            <ol class="terms-list">
                <li>当社は、法令改正、サービス内容変更、事業上の必要性その他合理的な理由がある場合、本規約を変更することができます。</li>
                <li>当社は変更後の規約を本サービスまたは当社ウェブサイト上に掲載するものとします。</li>
                <li>利用者が変更後も本サービスを利用した場合、変更後の規約に同意したものとみなします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第5条（通知）</h3>
            <ol class="terms-list">
                <li>当社から利用者への通知は、本サービス上での掲示、電子メールその他当社が適当と認める方法により行います。</li>
                <li>利用者が登録したメールアドレス宛に通知を送信した時点で、当該通知は到達したものとみなします。</li>
            </ol>
            <hr class="terms-divider">
            <h2 class="terms-chapter">第2章 利用契約</h2>
            <h3>第6条（利用申込）</h3>
            <ol class="terms-list">
                <li>本サービスの利用を希望する者は、本規約に同意のうえ、当社所定の方法により利用申込みを行うものとします。</li>
                <li>利用希望者は、申込時に真実かつ正確な情報を提供しなければなりません。</li>
                <li>利用者は、登録情報に変更が生じた場合、速やかに変更手続きを行うものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第7条（利用契約の成立）</h3>
            <ol class="terms-list">
                <li>当社が申込みを承諾した時点で利用契約が成立します。</li>
                <li>当社は以下の場合、申込みを拒否できるものとします。</li>
            </ol>
            ...
            <h3>第8条（利用料金）</h3>
            <ol class="terms-list">
                <li>利用者は当社が別途定める利用料金を支払うものとします。</li>
                <li>利用料金は当社ウェブサイト、申込書または個別契約に定めるものとします。</li>
                <li>利用料金は前払いとし、当社が別途認める場合を除き日割精算は行いません。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第9条（支払方法）</h3>
            <ol class="terms-list">
                <li>利用料金は以下の方法で支払うものとします。</li>
            </ol>
            ...
            <ol class="terms-list" start="2">
                <li>決済手数料は利用者負担とします。</li>
                <li>支払済みの利用料金は、本規約に明示的に定める場合を除き返金しません。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第10条（契約期間）</h3>
            <ol class="terms-list">
                <li>契約期間は当社が別途定める期間とします。</li>
                <li>月額契約は利用者から解約手続きが行われない限り自動更新されます。</li>
                <li>利用停止期間中であっても利用料金は発生するものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第11条（解約）</h3>
            <ol class="terms-list">
                <li>利用者は当社所定の方法により解約できます。</li>
                <li>解約月の利用料金について返金は行いません。</li>
                <li>解約後であっても、利用料金の未払債務は消滅しません。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第12条（即時解除）</h3>
            ...
            <h3>第16条（IDおよびパスワードの管理）</h3>
            <ol class="terms-list">
                <li>利用者は、本サービスに関するID、パスワードその他認証情報を自己の責任において管理するものとします。</li>
                <li>利用者は、IDまたはパスワードを第三者に貸与、譲渡、共有または利用させてはなりません。</li>
                <li>利用者の管理不十分、使用上の過誤または第三者による不正利用により発生した損害について、当社は責任を負いません。</li>
                <li>利用者は認証情報の漏えいまたは不正利用を認識した場合、直ちに当社へ通知しなければなりません。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第17条（SMS認証等）</h3>
            <ol class="terms-list">
                <li>当社は本人確認のため、SMS認証、メール認証その他当社が必要と認める認証手段を利用する場合があります。</li>
                <li>利用者は認証手続に必要な情報を正確に提供するものとします。</li>
                <li>認証が完了しない場合、当社はサービスの全部または一部の利用を制限できるものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第18条（アカウント利用責任）</h3>
            <ol class="terms-list">
                <li>利用者アカウントを用いて行われた行為は、当該利用者自身による行為とみなします。</li>
                <li>利用者は自己の責任において従業員その他利用権限を有する者を管理するものとします。</li>
                <li>従業員等による不正利用についても利用者が責任を負うものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第19条（利用権限の管理）</h3>
            <ol class="terms-list">
                <li>利用者は退職者その他利用資格を失った者のアカウントを速やかに停止しなければなりません。</li>
                <li>利用権限管理の不備により発生した損害について当社は責任を負いません。</li>
            </ol>
            <hr class="terms-divider">
            ...
            <h3>第21条（顧客情報の管理）</h3>
            <ol class="terms-list">
                <li>利用者は本サービスを通じて取得した顧客情報を自己の責任において管理するものとします。</li>
                <li>利用者は顧客情報の漏えい、紛失または不正利用を防止するため必要な措置を講じるものとします。</li>
                <li>利用者による顧客情報管理に起因する損害について当社は責任を負いません。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第22条（禁止事項）</h3>
            ...
            <h3>第23条（利用者の責任）</h3>
            <ol class="terms-list">
                <li>利用者は自己の責任と費用において本サービスを利用するものとします。</li>
                <li>利用者とエンドユーザーとの間で生じた紛争は利用者の責任で解決するものとします。</li>
                <li>当社が第三者から請求等を受けた場合、利用者は当社に生じた損害を補償するものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h2 class="terms-chapter">第6章 AIサービス特則</h2>
            <h3>第24条（AI機能の利用）</h3>
            <ol class="terms-list">
                <li>本サービスには生成AIを利用した機能が含まれます。</li>
                <li>AI機能は自動的に回答または提案を生成するものであり、人による確認を経ていない場合があります。</li>
                <li>AI機能は利用者の判断を支援するためのものであり、利用者の判断を代替するものではありません。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第25条（AI生成コンテンツ）</h3>
            <ol class="terms-list">
                <li>AIチャットその他AI機能により生成された回答、提案、要約、分析結果その他一切の出力内容（以下「AI生成コンテンツ」といいます。）は参考情報です。</li>
                <li>AI生成コンテンツは専門家による助言を構成するものではありません。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第26条（ハルシネーション等）</h3>
            <ol class="terms-list">
                <li>AI機能は事実と異なる情報を生成する場合があります。</li>
                <li>AI機能は以下の内容を含む場合があります。</li>
            </ol>
            ...
            <ol class="terms-list" start="3">
                <li>利用者は重要事項について必ず自ら確認するものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第27条（専門的助言の否認）</h3>
            ...
            <hr class="terms-divider">
            <h3>第28条（AI回答に関する免責）</h3>
            <ol class="terms-list">
                <li>当社はAI生成コンテンツの正確性、完全性、最新性、有用性を保証しません。</li>
                <li>利用者またはエンドユーザーがAI生成コンテンツを利用して行った判断について当社は責任を負いません。</li>
                <li>AI生成コンテンツに起因する損害について当社の故意または重過失による場合を除き、責任を負わないものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第29条（学習モデルおよび技術仕様）</h3>
            <p>当社はAI機能に使用する生成AIモデル、アルゴリズム、プロンプト設計、学習データその他技術仕様について開示義務を負いません。</p>
            <hr class="terms-divider">
            <h3>第30条（AIサービスの変更）</h3>
            <ol class="terms-list">
                <li>当社はAI機能の全部または一部を変更、中断または終了できるものとします。</li>
                <li>第三者AIサービスの仕様変更、回答品質変更、API停止またはサービス終了により、本サービスの全部または一部が利用できなくなった場合であっても、当社の故意または重過失による場合を除き、当社は責任を負わないものとします。利用者はこれをあらかじめ承諾するものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h2 class="terms-chapter">第7章 不動産サービス特則</h2>
            <h3>第31条（不動産情報の位置付け）</h3>
            <ol class="terms-list">
                <li>本サービスに掲載または提供される不動産情報、価格情報、取引事例情報、周辺環境情報、市場情報その他一切の情報は参考情報です。</li>
                <li>当社は当該情報の正確性、完全性、最新性または有用性を保証しません。</li>
                <li>利用者は自己の責任で情報を確認し利用するものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第32条（物件提案機能）</h3>
            <ol class="terms-list">
                <li>物件提案機能は利用者またはエンドユーザーが入力した条件に基づき候補物件を表示する機能です。</li>
                <li>提案物件は機械的に抽出された候補であり、利用者またはエンドユーザーの希望条件への適合性を保証するものではありません。</li>
                <li>提案結果に起因する損害について当社は責任を負いません。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第33条（AIマンション査定）</h3>
            <ol class="terms-list">
                <li>AIマンション査定機能により表示される価格は参考価格です。</li>
                <li>当社は査定価格が実際の売買価格、査定価格または成約価格と一致することを保証しません。</li>
                <li>利用者またはエンドユーザーは査定価格のみを根拠として重要な判断を行わないものとします。</li>
                <li>当社の故意または重過失による場合を除き、査定結果に起因して生じた損害について責任を負わないものとします。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第34条（住宅ローンシミュレーター）</h3>
            <ol class="terms-list">
                <li>ローンシミュレーターは利用者が入力した条件に基づき参考値を算出する機能です。</li>
                <li>シミュレーション結果は借り入れを保証するものではありません。</li>
                <li>金融機関の審査結果がシミュレーション結果と異なる場合があります。</li>
                <li>税制改正、金利変動、制度変更等により結果が変動する場合があります。</li>
                <li>当社はシミュレーション結果に起因する損害について責任を負いません。</li>
            </ol>
            <hr class="terms-divider">
            <h2 class="terms-chapter">第8章 システム利用</h2>
            <h3>第35条（外部サービスとの連携）</h3>
            <ol class="terms-list">
                <li>本サービスは、第三者が提供するAIサービス、クラウドサービス、認証サービス、決済サービス、通信サービスその他外部サービスと連携して提供される場合があります。</li>
                <li>当社は、外部サービスの障害、停止、仕様変更またはサービス終了により本サービスの全部または一部が利用できなくなった場合であっても、当社の故意または重過失による場合を除き、責任を負わないものとします。</li>
                <li>当社は、外部サービスの変更に伴い、本サービスの機能、仕様または提供方法を変更する場合があります。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第36条（メンテナンス）</h3>
            <ol class="terms-list">
                <li>当社は保守点検、アップデート、障害対応その他必要な場合、本サービスを停止できるものとします。</li>
                <li>緊急の場合、事前通知なく停止することができます。</li>
            </ol>
            <hr class="terms-divider">
            <h3>第37条（サイバー攻撃等）</h3>
            <ol class="terms-list">
                <li>当社は合理的な範囲でセキュリティ対策を講じます。</li>
                <li>しかしながら、以下を完全に防止することは保証できません。</li>
            </ol>
            ...
            <h3>第43条（返金制限）</h3>
            <ol class="terms-list">
                <li>利用者が支払った利用料金は、法令上返金義務がある場合または当社の故意もしくは重過失による場合を除き、返金しないものとします。</li>
                <li>以下の場合も同様とします。</li>
            </ol>
            ...
            <hr class="terms-divider">
            <h3>第48条（反社会的勢力の排除）</h3>
            <p>利用者は自らおよび役員等が反社会的勢力に該当しないことを表明保証します。</p>
            <hr class="terms-divider">
            <h3>第49条（権利義務の譲渡禁止）</h3>
            ...
            <hr class="terms-divider">
            <h3>第52条（準拠法および合意管轄）</h3>
            <ol class="terms-list">
                <li>本規約は日本法に準拠します。</li>
                <li>本サービスまたは本規約に関して生じた紛争については、東京地方裁判所または東京簡易裁判所を第一審の専属的合意管轄裁判所とします。</li>
            </ol>
            <hr class="terms-divider">
            <h2 class="terms-chapter terms-supplement">附則</h2>
            <p class="terms-date">制定日：2026年6月1日</p>
            <p class="terms-date">施行日：2026年6月1日</p>
