 ...
 * OFF の会社では、マイページに「組織・メンバー顧客」が出ない（APIも拒否する）。
 *
        ...
        <div class="admin-content">
            <div class="org-container">
                ...
                <p class="org-note">
                    ...
                    統括（全閲覧）は<strong>同じ免許番号のメンバー全員</strong>を、マネージャー（店長）は<strong>自分のメンバーだけ</strong>を閲覧できます。
                ...
                <div class="org-plan-panel">
                    ...
                    <p class="org-note">
                        ...
                        <strong>OFF の会社では、顧客管理に「組織・メンバー顧客」が表示されません</strong>（URLを直接開いてもエラーになります）。<br>
                        ...
                        右の欄に登録したメールでログインした方だけに「組織・メンバー顧客」が表示されます。
            ...
            document.querySelectorAll('.org-plan-toggle').forEach(function (toggle) {
                toggle.addEventListener('change', function () {
                    ...
                    var confirmText = enabled
                        ? label + ' の階層分け機能をONにします。\n顧客管理に「組織・メンバー顧客」が表示されるようになります。'
                        : label + ' の階層分け機能をOFFにします。\n顧客管理から「組織・メンバー顧客」が非表示になります。\n（統括・店長・配下の設定は消えません）';
