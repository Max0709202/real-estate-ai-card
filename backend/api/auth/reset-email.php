...
try {
    ...
    $escapedNewEmail = htmlspecialchars($newEmail, ENT_QUOTES, 'UTF-8');
    $emailBody = "
        <html>
        <head>
            <meta charset='UTF-8'>
                        ...
                        <table width='600' cellpadding='0' cellspacing='0' border='0' style='max-width:600px; width:100%; background-color:#ffffff; border:3px solid #a3a3a3; font-family:Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, sans-serif; color:#333;'>
                            ...
                            <tr>
                                <td style='background-color:#f9f9f9; padding:30px;'>
                                    <p style='margin:0 0 16px 0; line-height:1.8;'>メールアドレス変更のリクエストを受け付けました。</p>
                                    <p style='margin:0 0 16px 0; line-height:1.8;'>変更後メールアドレス: {$escapedNewEmail}</p>
                                    <p style='margin:0 0 16px 0; line-height:1.8;'>以下のボタンをクリックして、メールアドレス変更を完了してください。<br>このリンクは15分間有効です。</p>
                                    <div style='text-align:center; margin:28px 0;'>
                                        <a href='{$verificationLink}' target='_blank' rel='noopener noreferrer' style='display:inline-block; background:#0066cc; color:#ffffff; text-decoration:none; font-weight:bold; padding:12px 24px; border-radius:6px;'>メールアドレス変更を完了する</a>
                                    </div>
                                    ...
                                    <p style='margin:0; line-height:1.8;'>このメールに心当たりがない場合は、このメールを無視してください。メールアドレスは変更されません。</p>
                                </td>
                            </tr>
                            <tr>
